...
namespace Qlik.NPrinting.Rest.Client.Model
{
    ...
    public partial class UserResponseData :  IEquatable<UserResponseData>, IValidatableObject
    {
        ...
        public UserResponseData(int? TotalItems = default(int?), int? Offset = default(int?), int? Limit = default(int?), List<UserResponseDataItem> Items = default(List<UserResponseDataItem>))
        {
        ...
        public List<UserResponseDataItem> Items { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserResponseData);
        }

        /// <summary>
        /// Returns true if UserResponseData instances are equal
        /// </summary>
        /// <param name="other">Instance of UserResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserResponseData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
