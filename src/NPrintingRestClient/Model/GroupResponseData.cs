...
namespace Qlik.NPrinting.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupResponseData :  IEquatable<GroupResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupResponseData" /> class.
        /// </summary>
        /// <param name="TotalItems">TotalItems.</param>
        /// <param name="Offset">Offset.</param>
        /// <param name="Limit">Limit.</param>
        /// <param name="Items">Items.</param>
        public GroupResponseData(int? TotalItems = default(int?), int? Offset = default(int?), int? Limit = default(int?), List<GroupResponseDataItem> Items = default(List<GroupResponseDataItem>))
        {
        ...
        public List<GroupResponseDataItem> Items { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupResponseData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GroupResponseData);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GroupResponseData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
