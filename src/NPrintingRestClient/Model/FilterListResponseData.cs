...
namespace Qlik.NPrinting.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FilterListResponseData :  IEquatable<FilterListResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterListResponseData" /> class.
        /// </summary>
        /// <param name="TotalItems">TotalItems.</param>
        /// <param name="Offset">Offset.</param>
        /// <param name="Limit">Limit.</param>
        /// <param name="Items">Items.</param>
        public FilterListResponseData(int? TotalItems = default(int?), int? Offset = default(int?), int? Limit = default(int?), List<FilterResponseDataItems> Items = default(List<FilterResponseDataItems>))
        {
        ...
        public List<FilterResponseDataItems> Items { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FilterListResponseData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FilterListResponseData);
        }

        /// <summary>
        /// Returns true if FilterListResponseData instances are equal
        /// </summary>
        /// <param name="other">Instance of FilterListResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterListResponseData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
