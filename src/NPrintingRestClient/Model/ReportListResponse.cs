...
namespace Qlik.NPrinting.Rest.Client.Model
{
    ...
    public partial class ReportListResponse :  IEquatable<ReportListResponse>, IValidatableObject
    {
        ...
        public ReportListResponse(ReportListResponseData Data = default(ReportListResponseData))
        {
            this.Data = Data;
        }
        ...
        public ReportListResponseData Data { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReportListResponse);
        }

        /// <summary>
        /// Returns true if ReportListResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ReportListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportListResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
