...
{
    /// <summary>
    /// FilterResponseDataItems
    /// </summary>
    [DataContract]
    public partial class FilterResponseDataItems :  IEquatable<FilterResponseDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterResponseDataItems" /> class.
        /// </summary>
        /// <param name="Id">The unique identifier of the filter..</param>
        /// <param name="Appid">The unique identifier that represents a specific app..</param>
        /// <param name="Enabled">Indicates whether the filter is enabled..</param>
        ...
        /// <param name="Fields">The fields of the filter. It can be empty..</param>
        public FilterResponseDataItems(Guid? Id = default(Guid?), Guid? Appid = default(Guid?), bool? Enabled = default(bool?), DateTime? Created = default(DateTime?), DateTime? LastUpdate = default(DateTime?), string Name = default(string), string Description = default(string), List<FilterField> Fields = default(List<FilterField>))
        {
            this.Id = Id;
            this.Appid = Appid;
        ...
        /// </summary>
        /// <value>The unique identifier of the filter.</value>
        [DataMember(Name="id", EmitDefaultValue=false)]
        public Guid? Id { get; set; }
        /// <summary>
        /// The unique identifier that represents a specific app.
        /// </summary>
        /// <value>The unique identifier that represents a specific app.</value>
        ...
        /// <summary>
        /// The fields of the filter. It can be empty.
        /// </summary>
        /// <value>The fields of the filter. It can be empty.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FilterResponseDataItems {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as FilterResponseDataItems);
        }

        /// <summary>
        /// Returns true if FilterResponseDataItems instances are equal
        /// </summary>
        /// <param name="other">Instance of FilterResponseDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterResponseDataItems other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
