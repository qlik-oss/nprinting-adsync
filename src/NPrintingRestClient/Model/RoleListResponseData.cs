...
namespace Qlik.NPrinting.Rest.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoleListResponseData :  IEquatable<RoleListResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleListResponseData" /> class.
        /// </summary>
        /// <param name="TotalItems">TotalItems.</param>
        /// <param name="Offset">Offset.</param>
        /// <param name="Limit">Limit.</param>
        /// <param name="Items">Items.</param>
        public RoleListResponseData(int? TotalItems = default(int?), int? Offset = default(int?), int? Limit = default(int?), List<RoleResponseDataItem> Items = default(List<RoleResponseDataItem>))
        {
        ...
        public List<RoleResponseDataItem> Items { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoleListResponseData {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RoleListResponseData);
        }

        /// <summary>
        /// Returns true if RoleListResponseData instances are equal
        /// </summary>
        /// <param name="other">Instance of RoleListResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleListResponseData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
