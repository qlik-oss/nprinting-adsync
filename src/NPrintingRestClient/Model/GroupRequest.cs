...
namespace Qlik.NPrinting.Rest.Client.Model
{
    ...
    public partial class GroupRequest :  IEquatable<GroupRequest>, IValidatableObject
    {
        ...
        public GroupRequest(string Name = default(string), string Description = default(string), bool? Enabled = default(bool?))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for RequestGroup and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Enabled == null)
            {
                throw new InvalidDataException("Enabled is a required property for RequestGroup and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Returns true if RequestGroup instances are equal
        /// </summary>
        /// <param name="other">Instance of RequestGroup to be compared</param>
        /// <returns>Boolean</returns>
