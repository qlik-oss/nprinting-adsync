...
namespace Qlik.NPrinting.Rest.Client.Model
{
    ...
    public partial class UserUpdateRequest :  IEquatable<UserUpdateRequest>, IValidatableObject
    {
        ...
        /// <param name="Domainaccount">Domainaccount (required).</param>
        ...
        /// <param name="Subfolder">Subfolder (required).</param>
        public UserUpdateRequest(string Email = default(string), string Password = default(string), bool? Enabled = default(bool?), string Username = default(string), string Domainaccount = default(string), string Timezone = default(string), UserLocale? Locale = default(UserLocale?), string Folder = default(string), string Subfolder = default(string))
        {
            // to ensure "Email" is required (not null)
            if (Email == null)
            {
                throw new InvalidDataException("Email is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
                this.Email = Email;
            ...
            if (Password == null)
            {
                throw new InvalidDataException("Password is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
            ...
            if (Enabled == null)
            {
                throw new InvalidDataException("Enabled is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
            ...
            if (Username == null)
            {
                throw new InvalidDataException("Username is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
                this.Username = Username;
            }
            // to ensure "Domainaccount" is required (not null)
            if (Domainaccount == null)
            {
                throw new InvalidDataException("Domainaccount is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
            ...
            if (Timezone == null)
            {
                throw new InvalidDataException("Timezone is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
            ...
            if (Locale == null)
            {
                throw new InvalidDataException("Locale is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
                this.Locale = Locale;
            ...
            if (Folder == null)
            {
                throw new InvalidDataException("Folder is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
                this.Folder = Folder;
            }
            // to ensure "Subfolder" is required (not null)
            if (Subfolder == null)
            {
                throw new InvalidDataException("Subfolder is a required property for UserUpdateRequest and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserUpdateRequest);
        }
